package com.app.bkndtest1.model;
...
import com.app.bkndtest1.converter.DurationConverter;
import com.app.bkndtest1.converter.UUIDToByteConverter;
import com.app.bkndtest1.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"bkndtest1_094\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"bkndtest1_094\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"bkndtest1_094\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"bkndtest1_094\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"bkndtest1_094\"")
